...
<body>
  <header><h2>LOJA DE PRODUTOS PARAGUAIOS</h2></header>
    <h1>PESQUISAR NO ESTOQUE</h1>
    <form method="POST" action="estoque_dd.php" autocomplete="off">
        Pesquisar por dia:<input type="text" name="ddpesquisarv" id="datva" placeholder="PESQUISAR">
        <input type="submit" value=PROCURAR>
      </form><br><br>
      <form method="POST" action="estoque_mm.php" autocomplete="off">
        Pesquisar por mês:<input type="text" name="mmpesquisarv" id="datvd" placeholder="PESQUISAR">
        <input type="submit" value=PROCURAR>
      </form><br><br>
      <form method="POST" action="estoque_yy.php" autocomplete="off">
